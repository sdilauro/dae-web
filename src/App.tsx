...
export const App = () => (
  <ChakraProvider theme={theme} >
    <Box width={"100%"} justifyContent={"end"} display={'flex'} padding={5}>
      <ColorModeSwitcher justifySelf="flex-end" />
    </Box>
    <Box fontFamily={"monospace"} textAlign="left" fontSize="lg" width={"50%"} margin={'auto'}>
      <Box display={"flex"} alignItems={"center"} mb={"1rem"} w={"100%"} justifyContent={"space-between"}>
        <Box>
